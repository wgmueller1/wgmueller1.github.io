...
Here are a few examples of some well known filters from digital signal processing:

High and Low pass filters as convolutions
<img src="http://www.dspguide.com/graphics/F_6_3.gif">

Attenuator and Derivative filters
<img src="http://www.dspguide.com/graphics/F_6_4.gif">

The derivative of an input signal can be approximated by convolving the derivative of a Gaussian Filter or by using a discrete derivative filter (as shown above).  Since we typically use a max pooling layer after a convolutional layer, we are able to identify the maximum value of the derivative over the time interval of the input.
