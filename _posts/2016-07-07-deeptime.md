...
Many of the first ten features are approximately linearly correlated.  https://www.cs.toronto.edu/~hinton/absps/JMLRdropout.pdf described similiar phenomena and the effect on model performance.  The authors "Dropout" as method to prevent the units from co-adapting too much.  Adding dropout to our model might improve out of sample performance. Furthermore, correlated input data can affect learning speed.
