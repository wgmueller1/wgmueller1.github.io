...
It is easy to see that a simple moving average is a special case of a convolution using the following kernel:

$$
h = \left[
\begin{array}{c} \dfrac{1}{N} \, \dfrac{1}{N} \, ... \, \dfrac{1}{N}\, \dfrac{1}{N}\end{array}
\right]
$$
...
I'm a big fan of the neural networks library <a href="https://keras.io" target="_blank">Keras</a>.  Keras can run on top of the deep learning libraries Theano and Tensorflow and makes prototyping neural networks very easy.  Here I'll use Keras to build a convolutional neural network to predict the activities from the sensor data provided by Human Activity Recognition dataset.
...
<img src="https://www.dspguide.com/graphics/F_6_3.gif"><br>
...
<img src="https://www.dspguide.com/graphics/F_6_4.gif"><br>
...
Images from <a href="https://www.dspguide.com">https://www.dspguide.com</a>
...
<br>
<br>
<a name="myfootnote1">1</a>: https://deeplearning.net/tutorial/lenet.html
